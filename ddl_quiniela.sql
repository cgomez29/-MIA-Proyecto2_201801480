...
CREATE TABLE ADMINS(
    idadmin NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
 ...
 DELETE FROM ADMINS WHERE idadmin = 0;
 DELETE FROM ADMINS WHERE idadmin = 5;
 DELETE FROM ADMINS WHERE idadmin = 6;

SELECT * FROM ADMINS;

alter table ADMINS rename column ADMIN_ID to ADMINID;